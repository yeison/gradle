...
public class DependencyGraphBuilder {
    ...
    static class DependencyEdge implements InternalDependencyResult {
        ...
        public ModuleVersionIdentifier getSelected() {
            if (!getTarget().getSelectedId().equals(selector.getSelected().getSelectedId())) {
                throw new IllegalStateException("Selected id for: " + this.getRequested().getDisplayName()
                        + " is inconsistent: '" + getTarget().getSelectedId() + "' and '" + selector.getSelected().getSelectedId());
            }
            return getTarget().getSelectedId();
        }
